  ...
  return (
    <div className="bg-white flex flex-col  justify-center items-center w-screen h-screen text-[#636364] p-2 text-[16px] ">
      ...
      >
        ...
        <div className="absolute flex flex-col gap-2 bottom-1 w-full p-1 ">
          <Button
            className="bg-red-400 text-white w-full px-1 py-1.5 text-center"
            onClick={() => router.push("/addAuto")}
          >
            Inserer une nouvelle auto
          </Button>
          <Button
            className="bg-[#191919] text-white w-full px-1 py-1.5 text-center"
