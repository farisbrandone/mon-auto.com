...
import { DataTableAutoPagination } from "./DataTableAutoPagination";
import { DataTableUserViewOptions } from "../basckoffice-user-dashboard/DataTableUserViewOption";
...
export function DashboardAutoTable<TData, TValue>({
  columns,
  data,
  setUserData,
  setActualPage,
                  ...
                  >
                    {row.getVisibleCells().map((cell) => (
                      <TableCell key={cell.id}>
                        ...
                        {/*  {!!Mycomponent && Mycomponent({ row: row.original })} */}
                      </TableCell>
                    ))}
                  </TableRow>
                );
